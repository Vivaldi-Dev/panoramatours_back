...
exports.reservarPacote = void 0;
const tourPackageEmail_1 = require("../utils/tourPackageEmail");
const reservarPacote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    `;
        const emailResult = yield (0, tourPackageEmail_1.sendEmail)({
